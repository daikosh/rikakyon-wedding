...
def main():
    ...
    with st.beta_expander("日時・会場", expanded=True):
        st.markdown('<p style="font-size: 28px">日時: 2022年3月26日 (日)', unsafe_allow_html=True)
        st.markdown('<p style="font-size: 28px">会場: <a href="https://www.fortunegarden.com/?utm_source=googleMyBusiness&utm_medium=referral" target="_blank">Fortune Garden 京都</a></p>', unsafe_allow_html=True)
        st.markdown(
    ...
    with st.beta_expander("その他", expanded=True):
        pass
