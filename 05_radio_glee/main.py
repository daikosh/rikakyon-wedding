...
def open_radio(imgpath, mp3path, format):
...
def main(debug):
    ...
    if RELEASE_TIME < NOW_TIME or debug is True: # リリース時間になったとき
        with st.beta_expander('#1 「恥ずかしながら帰ってまいりました。」【出演: 阿久澤、松岡、林、松井】', expanded=False):
            open_radio('05_radio_glee/radio_1.jpg', '05_radio_glee/radio_1.m4a', 'm4a')
        with st.beta_expander('#2 「〈TL第1章〉楽器を始めてなかった頃。」【出演: 犬飼、松井、松岡、阿久澤】', expanded=True):
            open_radio('05_radio_glee/radio_2.png', '05_radio_glee/radio_2.mp3', 'mp3')
        st.write("To be continued ...")
    else:
        with st.beta_expander('#1 「恥ずかしながら帰ってまいりました。」【出演: 阿久澤、松岡、林、松井】', expanded=False):
            open_radio('05_radio_glee/radio_1.jpg', '05_radio_glee/radio_1.m4a', 'm4a')
        with st.beta_expander('#2 「〈TL第1章〉楽器を始めてなかった頃。」【出演: 犬飼、松井、松岡、阿久澤】', expanded=False):
            open_radio('05_radio_glee/radio_2.png', '05_radio_glee/radio_2.mp3', 'mp3')
        st.write("To be continued ...")
